...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Create inline keyboard with Watch Now button (URL button)
    keyboard = [
        [InlineKeyboardButton(
            "Watch Now", 
            url="https://study-material-testing.vercel.app/"
        )]
    ]
...
def main() -> None:
    ...
    application.run_webhook(
        ...
        port=port,
        url_path=token,
        webhook_url=f"https://sm-testing-bot-v2.onrender.com/{token}"
    )
